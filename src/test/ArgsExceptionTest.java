...
import com.company.ArgsException;
...
public class ArgsExceptionTest extends TestCase
{
  ...
  public void testMissingMapMessage() throws Exception {
    ArgsException e = new ArgsException(ArgsException.ErrorCode.MISSING_MAP, 'x', null);
    assertEquals("Could not find map string for -x.", e.errorMessage());
  }

  public void testMalformedMapMessage() throws Exception {
    ArgsException e = new ArgsException(ArgsException.ErrorCode.MALFORMED_MAP, 'x', null);
  ...
  public void testInvalidFormat() throws Exception {
    ArgsException e = new ArgsException(ArgsException.ErrorCode.INVALID_ARGUMENT_FORMAT, 'x', "$");
